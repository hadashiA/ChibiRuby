MRuby::Gem::Specification.new('chibiruby-benchmark-helper') do |spec|
  spec.license = 'MIT'
...
MRuby.each_target do
  ...
  mruby_sharedlib = "#{build_dir}/lib/libchibiruby_benchmark_helper.#{sharedlib_ext}"
  ...
  task mruby_sharedlib => libmruby_static do |t|
    ...
    deffile = "#{File.dirname(__FILE__)}/chibiruby-benchmark-helper.def"
